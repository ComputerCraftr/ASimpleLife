...
pub(super) fn print_hashlife_summary(
    ...
    eprintln!(
        "{} total_us={} nodes={} retained_roots={} nodes_match_intern={} dependency_stalls={} jump_result_hit_rate={:.3} jump_result_misses={} oriented_result_hit_rate={:.3} root_result_hit_rate={:.3} jump_presence_hit_rate={:.3} overlap_hit_rate={:.3} overlap_local_reuse_rate={:.3} symmetry_gate_allow_rate={:.3} symmetry_gate_canonical_cache_bypasses={} structural_fast_path_hit_rate={:.3} canonical_cache_hit_rate={:.3} canonical_packed_cache_hit_rate={:.3} canonical_oriented_cache_hit_rate={:.3} direct_parent_winner_hit_rate={:.3} direct_parent_cached_result_hits={} direct_parent_winner_fallbacks={} symmetry_scan_fallbacks={} symmetry_jump_result_hits={} simd_lane_coverage={:.3} scalar_commit_ratio={:.3} probes_per_scheduler_task={:.3} recursive_overlap_batch_rate={:.3} gc_reclaim_ratio={:.3} gc_compact_ratio={:.3} gc_transient_entries_before={} gc_canonical_cache_entries_before={} gc_skipped_with_transient_growth={} canonical_packed_cache_entries={} canonical_oriented_cache_entries={} direct_parent_cache_entries={} structural_fast_path_cache_entries={} packed_structural_fast_path_cache_entries={} oriented_result_cache_entries={} packed_transform_intern_entries={} packed_d4_misses={} packed_inverse_transform_hits={} packed_recursive_transform_hits={} packed_recursive_transform_misses={} packed_overlap_outputs={} packed_result_materializations={} session_full_grid_materializations={} session_bounded_grid_extractions={} embedded_result_bounded_extractions={} clipped_viewport_extractions={} checkpoint_cell_materializations={} oracle_confirmation_materializations={} dense_fallback_invocations={} transformed_node_materializations={} gc_reason={} gc_runs={} gc_skips={}",
        label,
        elapsed.as_micros(),
        summary.total_nodes,
        ...
        summary.symmetry_scan_fallbacks,
        ...
        summary.gc_transient_entries_before,
        ...
        summary.session_bounded_grid_extractions,
...
pub(super) fn print_hashlife_gate_comparison(
    ...
    eprintln!(
        "{} mode={} total_us={} jump_result_hit_rate={:.3} oriented_result_hit_rate={:.3} root_result_hit_rate={:.3} jump_presence_hit_rate={:.3} symmetry_gate_allow_rate={:.3} symmetry_gate_canonical_cache_bypasses={} structural_fast_path_hit_rate={:.3} canonical_cache_hit_rate={:.3} canonical_packed_cache_hit_rate={:.3} canonical_oriented_cache_hit_rate={:.3} direct_parent_winner_hit_rate={:.3} direct_parent_cached_result_hits={} direct_parent_winner_fallbacks={} symmetry_scan_fallbacks={} symmetry_jump_result_hits={} probes_per_scheduler_task={:.3} simd_lane_coverage={:.3} overlap_hit_rate={:.3} gc_reason={} gc_runs={} gc_transient_entries_before={} gc_canonical_cache_entries_before={} canonical_packed_cache_entries={} canonical_oriented_cache_entries={} direct_parent_cache_entries={} structural_fast_path_cache_entries={} packed_structural_fast_path_cache_entries={} oriented_result_cache_entries={}",
        label,
        mode,
        elapsed.as_micros(),
        summary.jump_result_hit_rate,
